    ...
    return (
        <div ref={containerRef} className="relative flex-1">
            <form
                ...
                className="flex items-center rounded-lg border border-gray-500 transition-all duration-300 focus-within:border-[var(--color-accent)] focus-within:shadow-[0_0_0_2px_var(--color-accent-glow)]"
            >
                <input
                    type="text"
                    value={query}
                ...
                <button
                    ...
                    className={`flex cursor-pointer items-center justify-center rounded-r-lg bg-[var(--color-accent)] text-[var(--color-accent-foreground)] transition-colors duration-300 hover:bg-[var(--color-accent-hover)] ${buttonClassName}`}
                >
                    {loading ? (
                        <svg
                            width="18"
